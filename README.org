...
** LISP
   |-----------------------+-----------------------------------------------------------------------------+------------------+----------------+------------------|
   | *LISP-1*              | Active                                                                      | Installer        | PackageManager | PackageViewer    |
   |-----------------------+-----------------------------------------------------------------------------+------------------+----------------+------------------|
   ...
   | [[http://joxa.org/][Joxa]]                  |                                                                             |                  |                |                  |
   | [[https://gamelisp.rs/][GameLisp]]              | [[https://gamelisp.rs/][https://img.shields.io/github/last-commit/fleabitdev/glsp?logo=GameLisp.svg]] | [[https://crates.io/crates/glsp/][crate]]            |                |                  |
   |-----------------------+-----------------------------------------------------------------------------+------------------+----------------+------------------|
   ...
   | [[https://lfe.io/][LFE]]                   |                                                                             |                  |                |                  |
   |-----------------------+-----------------------------------------------------------------------------+------------------+----------------+------------------|
   | *Clojure like*        |                                                                             | Installer        | PackageManager | PackageViewer    |
   |-----------------------+-----------------------------------------------------------------------------+------------------+----------------+------------------|
   | *[[https://clojure.org/][Clojure]]* ([[https://clojuredocs.org/][Docs]])      |                                                                             | [[https://sdkman.io/sdks#leiningen][SDKMAN]]           | [[https://leiningen.org/][Leiningen]]      | [[https://clojars.org/][clojars]]          |
   | [[https://github.com/clojure/clojure-clr][Clojure-CLR]] ([[https://arcadia-unity.github.io/][Arcadia]]) |                                                                             |                  |                |                  |
   ...
   | [[https://joker-lang.org/][Joker]]                 |                                                                             | [[https://joker-lang.org/][INSTALL]]          |                |                  |
   ...
   | [[https://ferret-lang.org/][Ferret]]                |                                                                             | lein             |                |                  |
   | [[https://github.com/Toccata-Lang/toccata][Toccata]]               |                                                                             |                  |                |                  |
   | [[https://github.com/clojerl/clojerl][Clojerl]]               |                                                                             | [[https://github.com/clojerl/clojerl][building]]         |                |                  |
   | [[https://github.com/lsevero/abclj][ArmedBearClojure]]      |                                                                             |                  |                |                  |
   | [[https://github.com/Gozala/wisp][Wisp]]                  |                                                                             | npm              | npm/yarn       | /                |
   | [[hylang.org][Hy]]                    |                                                                             | [[https://pypi.org/project/pip/][pip]]              | [[https://pypi.org/project/pip/][pip]]            | [[https://pypi.org][PyPI]]             |
   | [[https://github.com/timothypratley/rustly][Rustly]]                |                                                                             |                  |                |                  |
   | [[https://github.com/ruricolist/cloture][Cloture]]               |                                                                             |                  |                |                  |
   | [[https://github.com/joinr/clclojure][CLClojure]]             |                                                                             |                  |                |                  |
