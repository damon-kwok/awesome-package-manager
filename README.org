...
| Language          | Installer      | PackageManager     | PackageViewer      |
|-------------------+----------------+--------------------+--------------------|
...
| [[https://github.com/epitron/upm#package-tools-to-wrap][Universal]]       | None      | [[https://github.com/epitron/upm][upm]]               | None                  |
